...
{
    public class LinkSummaryConfiguration : IEntityTypeConfiguration<LinkSummaryEntity>
    {
        public void Configure(EntityTypeBuilder<LinkSummaryEntity> builder)
        {
            builder.ToTable("LinkSummary");
            ...
            builder.HasIndex(e => e.VisitTimeUTC)
                .HasDatabaseName("idx_pagevisits_visittime4")
                .IsDescending(true);

            builder.HasIndex(e => e.OperatingSystem)
                .HasDatabaseName("idx_pagevisits_os4");
