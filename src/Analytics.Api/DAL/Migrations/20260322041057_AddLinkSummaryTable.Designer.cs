...
namespace Analytics.Api.DAL.Migrations
{
    ...
    [Migration("20260322041057_AddLinkSummaryTable")]
    partial class AddLinkSummaryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Analytics.Api.DAL.Entities.LinkSummaryEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("VisitTimeUTC")
                        .IsDescending()
                        .HasDatabaseName("idx_pagevisits_visittime4");

                    b.ToTable("LinkSummary", null, t =>
                        {
                            t.HasComment("Таблица для хранения посещений страниц");
                        });
                });

            modelBuilder.Entity("Analytics.Api.DAL.Entities.MppTestsEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("MppTests", null, t =>
                        {
                            t.HasComment("Таблица для хранения посещений страниц");
                        });
                });

            modelBuilder.Entity("Analytics.Api.DAL.Entities.OfftubeTechEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
